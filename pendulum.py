...
from tensorflow.python.ops.gen_nn_ops import max_pool_grad_with_argmax
...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, fc1_dims=256, fc2_dims=256,
        ...
        self.name = name
        self.file = os.path.join(chkpt_dir, name+'_sac')
...
for i in range(n_games):
    ...
    while True:
        ...
        score += reward
        agent.remember(observation, action, reward, observation_new, terminated)
        agent.learn()
